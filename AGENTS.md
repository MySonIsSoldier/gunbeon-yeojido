...
장병과 가족·연인·친구가 강원 접경 여행을 계획하고, 개인 복귀 기준을 확인하며, 다녀온 하루를 기록하는 모바일 웹/PWA다. **2026-09-19 사용자 확인: 1차 심사 완료, 현재 PC 작업 일시 중단·이전 준비.** 과거 9월 21일 제출 목표와 미접수 기록은 당시 이력이다. 심사 결과를 추측하지 말고 다음 단계 지시를 확인한다.
