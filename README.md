...
6. **출타와 기록** — 내 여행에 담은 뒤 개인 복귀 기준을 정하고 ‘출타 시작’을 누릅니다. 여행이 끝나면 실제 다녀온 관광지를 선택하고 스탬프를 남깁니다. ‘하루의 한 장’은 이미지·문구로 저장할 수 있습니다. 모든 사용자가 상단의 ‘여행 가이드 다시 보기’에서 20초 안내와 기능별 사용법을 열 수 있습니다.
