...
> **공모전 1차 제출 준비(9/16):** [지정 기능설명서·이미지·접수 가이드](docs/submission/2026-round1/README.md). ① 웹·앱 개발 부문, 9/21 16:00 마감. 자료 준비 완료이며 최종 접수는 별도입니다.
...
- 개인 계정·서버 저장·기기 여행 가져오기, 네이버 운영 연결·Google 연결 준비, 여행 카드 더보기 메뉴
...
개인 아이디 로그인과 계정별 서버 저장을 지원합니다. 9/15 네이버 운영 연결과 기존 회원의 실제 재로그인을 확인하고 검수용 캡처를 준비했습니다. 네이버 일반 공개 검수와 최초 가입·새 동의 실검증, Google 키 설정·실로그인은 남아 있습니다. 비밀번호 재설정 메일은 아직 없습니다. 게스트 참여는 브라우저 쿠키를 유지해야 합니다. 초대는 72시간 동안 유효하고 관리자에게 취소·멤버 제외·그룹 삭제 기능이 있습니다.
