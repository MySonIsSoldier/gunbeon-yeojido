...
- 접경 5군 각 6개·춘천/속초 각 3개, 총 36개 추천 코스. 607개 지역 공개자료 유지, TourAPI 국문 7종 목록·추가 페이지·별도 장소 찾기·장소 하나로 일정 만들기. 실제 7개 권역 첫 조회 1,255건, 운영 춘천 331건+다음 페이지 5건 확인. 원문/사진 D1 저장 없음.
